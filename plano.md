...
|-------|-----------|---------------------|
| US-01 | Gerenciar Ciclo de Vida do Simulador | US-01.1, US-01.2, US-01.3, US-01.4, US-01.5, US-01.6, US-01.7, US-01.8, US-01.9 |
...
## Sprint 1 — Modo Servidor e Material Criptográfico
...
### US-01.7 — Agendar interrupção do assinador.jar por inatividade
...
## Sprint 3 — Fundação e Entrega Contínua
...
## Sprint 4 — Assinatura Digital Simulada (modo local)

**Objetivo:** Entregar o fluxo completo ponta-a-ponta: o usuário executa um comando no CLI e obtém uma assinatura simulada ou validação, via invocação local do assinador.jar.

**Valor entregue:** O caso de uso principal funciona. O usuário cria e valida assinaturas digitais simuladas via CLI, sem configurar Java manualmente.

### US-04.1 — Simulação de criação de assinatura digital
...
### US-04.2 — Validação de parâmetros de criação de assinatura
...
### US-04.3 — Simulação e validação de parâmetros de validação de assinatura
...
### US-04.4 — Parsing de comandos e parâmetros no CLI
...
### US-04.5 — Invocação do assinador.jar no modo local
...
### US-04.6 — Exibição legível de resultados
...
### US-04.7 — Detecção e provisionamento automático do JDK
...
## Sprint 5 — Simulador do HubSaúde e Segurança de Artefatos
